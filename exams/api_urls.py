...
from .api import (
    ...
    UNEBContinuousAssessmentViewSet, UNEBExportBatchViewSet, UNEBIntegrationAdapterViewSet,
...
router.register("uneb-integration-adapters", UNEBIntegrationAdapterViewSet, basename="uneb-integration-adapter")
